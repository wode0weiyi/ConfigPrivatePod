...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HGYinOrganization/YinUtils"
  ...
  s.source       = { :git => "https://github.com/HGYinOrganization/YinUtils.git", :tag => s.version.to_s }
  ...
  s.source_files  = "YinUtils/YinUtils/**/*.{h,m}"
